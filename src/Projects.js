        ...
        <div className="text-center" id="project">
            ...
            <div className="d-grid justify-content-center">
                <div className="project-block">
                    <a href="https://github.com/pavankarimi/Task-Management-App" target="_blank">
                        <img src="/tm.jpg" alt="GitHub Link" class="img"/>
                    </a>
                    <div className="p-3">
                ...
                <div className="project-block">
                    <a href="https://github.com/pavankarimi/pneumonia-detection-by-using-machine-learning" target="_blank">
                        <img src="/ml.jpg" alt="GitHub Link" class="img"/>
                    </a>
                    <div className="p-3">
